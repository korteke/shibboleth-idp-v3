 ...
 * 
 * @param <Type> the type of data returned by the function
 */
public abstract class AbstractAttributeResolutionLookupFunction<Type>
    ...
    /** {@inheritDoc} */
    @Override @Nullable public Type apply(@Nullable final ProfileRequestContext input) {
        if (input != null) {
     ...
     * 
     * @param input the context to examine
     * @return  the data to return
     */
    @Nullable protected abstract Type doApply(@Nonnull final AttributeResolutionContext input);
